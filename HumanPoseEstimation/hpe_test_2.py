...
if (len(pose_estimator) == 0):
    ...
    pose_estimator_dim.append( < detected objects boundary>)
    ...
    for dim in pose_estimator_dim:
        score = compareDist(dim, < detected objects boundary>)
    ...
    pose_estimator_dim[selected_pose_idx] = < detected objects boundary>
